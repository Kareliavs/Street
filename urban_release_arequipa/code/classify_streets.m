...
%%
% Now run experiments.
%separado/ simple / pasos / una ciudad NY bajar, vector de carac, binary
%data, entre, test
% entre , test 
%carpeta compartida jpocom@gmail.com
%papers --> colocar papaers relacionados
%docs--> ideas --> objetivo 2 o 3
%reuniones--> fecha hoy cosas que discutimos , tareas pendientes 
