...
api_key = 'AIzaSyCQGajheBaRe0Vqip4ge1Z3u1HTy0VSJ_Q';
    ...
    for ii = 1 : n_pages
        ...
        for j = 1 + (ii - 1) * results_per_page : min(length(c_inds), ii * results_per_page)
            if ~isnan(sc(j))
                ...
                fprintf(f, '<td><img src="http://localhost:8000/raid/data/vicente/urban_release/data/images/id_%s_%d_%d.jpg" height="207"/></td>', ...
